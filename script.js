...
function analyze() {
  ...
  if (
    ...
    alert(
      "กรุณากรอกเลขหลักแรก และเลข 4 หลักสุดท้ายให้ครบ"
    );
  ...
  if (first !== "0") {
    ...
    alert(
      "หมายเลขโทรศัพท์แบบ National Format ของไทยต้องขึ้นต้นด้วย 0"
    );
...
function renderResults(last) {
  ...
  const candidatesPerFamily =
    10000;

  const filteredCandidateCount =
    candidatesPerFamily *
    mobileFamilies.length;
  ...
  let html = `
    ...
    ">
      ...
      จาก
      ${rawCandidateCount.toLocaleString()}
      รูปแบบเริ่มต้น

      เมื่อกรองตาม mobile numbering family
      ที่ระบบรองรับ

      จะเหลือ

      <strong>
        ${filteredCandidateCount.toLocaleString()}
      </strong>
        ...
        <div class="family">
          ...
          <div class="family-head">
            ...
            <div class="badge">
              ...
              ${candidatesPerFamily.toLocaleString()}
              candidates
  ...
  html += `
    ...
    <div class="box">
      ...
      ถ้ายังไม่มีข้อมูลเพิ่มเติม
      ที่ทำให้ candidate ตัวหนึ่ง
      มีน้ำหนักมากกว่าอีกตัวหนึ่ง
      ...
      ตัวเลขนี้เป็น probability
      ภายใน candidate model เท่านั้น
